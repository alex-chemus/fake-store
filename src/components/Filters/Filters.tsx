...
const Filters: FC = () => {
  ...
  if (appliedFilter) return (
    <div className={classes.FiltersSection} id="filters">
      <div data-test={appliedFilter} className={classes.Badge}>{appliedFilter}</div>
    
      <button id="remove-filter" onClick={resetFilter} className={classes.ResetButton}>
